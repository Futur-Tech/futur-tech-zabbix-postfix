...
APP_NAME="futur-tech-zabbix-postfix"
REQUIRED_PKG_ARR=( "at" "pflogsumm" "pygtail" )
...
echo "zabbix ALL=(ALL) NOPASSWD:${BIN_DIR}/zabbix-postfix-stats.sh" | sudo EDITOR='tee -a' visudo --file=$SUDOERS_ETC &>/dev/null
